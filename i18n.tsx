...
const messages = {
    en: {
        ...
        practiceWrong: 'Not yet — recalculate the expression and try again.', interactiveAbacus: 'Interactive abacus',
        operation: 'Operation', mixed: 'Mixed', addition: 'Addition', subtraction: 'Subtraction', multiplication: 'Multiplication',
        division: 'Division', solveExercise: 'Calculate and place the answer on the abacus.', answerWas: 'Answer',
        hardNeedsRods: 'Hard requires at least 6 integer rods.', mediumNeedsRods: 'Medium requires at least 3 integer rods.',
    ...
    fa: {
        ...
        practiceWrong: 'هنوز نه؛ عبارت را دوباره محاسبه کن و پاسخ تازه‌ای بساز.', interactiveAbacus: 'چرتکهٔ تعاملی',
        operation: 'عملیات', mixed: 'ترکیبی', addition: 'جمع', subtraction: 'تفریق', multiplication: 'ضرب',
        division: 'تقسیم', solveExercise: 'محاسبه کن و پاسخ را روی چرتکه قرار بده.', answerWas: 'پاسخ',
        hardNeedsRods: 'سطح سخت حداقل به ۶ میلهٔ صحیح نیاز دارد.', mediumNeedsRods: 'سطح متوسط حداقل به ۳ میلهٔ صحیح نیاز دارد.',
